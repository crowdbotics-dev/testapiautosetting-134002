...
class Testconnectors134002ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS134002_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS134002_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS134002"
